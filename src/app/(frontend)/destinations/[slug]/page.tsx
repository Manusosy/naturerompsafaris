      ...
      <div className="accdet__layout">
        ...
        <aside className="accdet__sidebar">
          <div className="accdet__book-card">
            ...
            <ul className="accdet__trust-list">
              <li>
                <svg fill="none" height="20" stroke="#25a244" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="20">
                  <rect height="18" rx="2.5" ry="2.5" width="18" x="3" y="3" />
